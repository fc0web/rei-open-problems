...
**Canonical citation**: Fujimoto, N. (2026). *Open Problems META-DB (Rei-AIOS): D-FUMT₈ META-Classification of 2620 Open Problems*. Paper 130. Zenodo. DOI: [10.5281/zenodo.19700758](https://doi.org/10.5281/zenodo.19700758)

**License**: [CC-BY 4.0](LICENSE) — free to reuse with attribution.

**Version**: 2.0-public (snapshot generated 2026-07-18)

---

## What this is

A structured meta-database of **2734 mathematical unsolved problems + Rei-AIOS research contributions**, classified by:
...
| **2** | Rei Inventions | 108 | Rei-AIOS Invention Engine approved conjectures (framework: I(x) = Ψ × Φ × Ω, see Paper 132) |
